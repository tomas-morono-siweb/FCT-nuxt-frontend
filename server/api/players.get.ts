export default defineEventHandler(async (event) => {
  ...
  try {
    ...
    const mockPlayers = [
      ...
      { id: 6, nombre: "Mohamed", apellidos: "Salah", dorsal: 11, salario: 25000000, id_club: "LIV" },
      { id: 7, nombre: "Virgil", apellidos: "van Dijk", dorsal: 4, salario: 20000000, id_club: "LIV" },
      { id: 8, nombre: "Luka", apellidos: "Modrić", dorsal: 10, salario: 18000000, id_club: "RMA" },
      { id: 9, nombre: "Robert", apellidos: "Lewandowski", dorsal: 9, salario: 22000000, id_club: "FCB" },
      { id: 10, nombre: "Neymar", apellidos: "Jr", dorsal: 10, salario: 28000000, id_club: "PSG" }
    ];
