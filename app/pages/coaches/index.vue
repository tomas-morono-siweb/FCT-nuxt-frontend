    ...
    <div class="mx-auto max-w-7xl">
      ...
      <div class="mb-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 class="text-3xl font-bold text-gray-900">Entrenadores</h1>
            <p class="mt-2 text-sm text-gray-600">Gestiona la información de los entrenadores del equipo</p>
          </div>
          <NuxtLink
            to="/coaches/nuevo"
      ...
      <div class="mb-6 rounded-xl border border-gray-200 bg-white shadow-sm">
        <div class="p-6">
          <div class="flex flex-col gap-4 sm:flex-row">
            <div class="flex-1">
              <label class="mb-2 block text-sm font-medium text-gray-700">Buscar entrenador</label>
              <div class="relative">
                ...
                <tr v-if="pending">
                  ...
                  >
                    <div class="flex flex-col items-center">
                      ...
                      <p class="mt-2 text-sm text-gray-500">Cargando entrenadores...</p>
                    </div>
                  </td>
                </tr>
