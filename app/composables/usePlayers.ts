...
export const usePlayers = () => {
    const list = (q?: string, page = 1, pageSize = 10) => $fetch<Player[]>('/api/players', { query: { q, page, pageSize } });
    ...
    const update = (id: number, payload: Partial<Player>) => $fetch<Player>(`/api/players/${id}`, { method: 'PUT', body: payload });
